...
func stopCommandHandler(s *discordws.WellensittichSession, i *discordgo.InteractionCreate) {
	...
	vc.VoiceSender.StopPlaying()

	// success
	err = ic.DefaulInteractionAnswer("Successfully stopped playing.")
	if err != nil {
