...
func pauseCommandHandler(s *discordws.WellensittichSession, i *discordgo.InteractionCreate) {
	...
	vc.VoiceSender.PausePlaying()

	// success
	err = ic.DefaulInteractionAnswer("Successfully paused the current play.")
	if err != nil {
