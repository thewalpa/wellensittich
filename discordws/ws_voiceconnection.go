...
func NewWellensittichVoiceConnection(gID string, wss *WellensittichSession, vc *discordgo.VoiceConnection) *WellensittichVoiceConnection {
	return &WellensittichVoiceConnection{
		VoiceConnection: vc,
		VoiceSender:     NewVoiceSender(),
